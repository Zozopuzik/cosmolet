...
let AirPlane = function(){
  ...
  let geomCabin = new THREE.CylinderGeometry(40,22,50,50);
  let matCabin = new THREE.MeshPhongMaterial({color:Colors.blue, shading:THREE.FlatShading});
  geomCabin.rotateZ(Math.PI/2)
  ...
  let geomEngine = new THREE.CylinderGeometry( 22,1, 80, 50, 50 );
  let matEngine = new THREE.MeshPhongMaterial({color:0X5F687A, shading:THREE.FlatShading});
  geomEngine.rotateZ(Math.PI/2)
  ...
  // Tail Plane
   ...
   let geomTailPlane = new THREE.CylinderGeometry(50,40, 80, 50, 50);
   geomTailPlane.rotateZ(Math.PI/2)
   let matTailPlane = new THREE.MeshPhongMaterial({color:0X5F687A , shading:THREE.FlatShading});
   let tailPlane = new THREE.Mesh(geomTailPlane, matTailPlane);
   tailPlane.position.x = -45;
  ...
  let geomSideWing = new THREE.BoxGeometry(30,5,120,2,2,1);
  let matSideWing = new THREE.MeshPhongMaterial({color:0X1C273C, shading:THREE.FlatShading});
  let sideWing = new THREE.Mesh(geomSideWing, matSideWing);
  sideWing.castShadow = true;
  sideWing.position.x = -50;
  sideWing.receiveShadow = true;
  
  let sideWing2 = sideWing.clone()
  sideWing2.position.x = -70;
  sideWing2.rotateZ(Math.PI/2)

  let sideWing3 = sideWing.clone()
  sideWing3.position.x = -50;
  sideWing3.rotateX(Math.PI/2)
  
  let sideWing4 = sideWing.clone()
  sideWing4.position.x = -70;
  sideWing4.rotateZ(Math.PI/2)
  sideWing4.rotateY(Math.PI/2)
  this.mesh.add(sideWing, sideWing2, sideWing3, sideWing4);


  let suspensionGeom = new THREE.BoxGeometry(4,50,4);
  suspensionGeom.applyMatrix(new THREE.Matrix4().makeTranslation(0,10,0))
  let suspensionMat = new THREE.MeshPhongMaterial({color:Colors.blue, shading:THREE.FlatShading});
...
Cloud = function(){
  ...
  //*
  let nBlocs = 10+Math.floor(Math.random()*3);
...
function updatePlane(){
  ...
  camera.fov = normalize(window.innerWidth,-1,1,40, 80);
  camera.updateProjectionMatrix ()
